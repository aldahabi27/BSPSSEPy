...
trn_info_dict = {
    ...
    'TOEXNAME': (' To bus extended bus name (three-winding transformer name'
    ...
    'ZG1CZG': (' Zero sequence winding 1 grounding impedance in units governed'
               ' by CZG'),
    'ZG2': "ZGRND2' Zero sequence winding 2 grounding impedance in pu",
    'ZG2CZG': (' Zero sequence winding 2 grounding impedance in units governed'
               ' by CZG'),
