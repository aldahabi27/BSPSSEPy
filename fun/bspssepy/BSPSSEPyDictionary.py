...
# from .Sim.BSPSSEPyLoadFunctions import *
# from .Sim.BSPSSEPyTWTransformerFunctions import *
# from .Sim.BSPSSEPyBusFunctions import *
# from .Sim.BSPSSEPyDefaultVariables import *
# from Functions.BSPSSEPyPrintMessage import *
# from Functions.BSPSSEPyControlSequenceFunctions import *
# from Functions.BSPSSEPyPlotFunctions import *
# from Functions.BSPSSEPy.BSPSSEPyDictionary import *


# All possible representation of device types
DeviceTypeMapping = {
    '1': 'GEN', 'g': 'GEN', 'gen': 'GEN', 'generator': 'GEN',
    '2': 'TRN', 't': 'TRN', 'twtf': 'TRN', 'twtransformer': 'TRN', "trn":"TRN",
    '3': 'BRN', 'br': 'BRN', 'brn': 'BRN', 'branch': 'BRN',
    '4': 'LOAD', 'l': 'LOAD', 'load': 'LOAD',
    '5': 'BUS', 'b': 'BUS', 'bus': 'BUS'
}

# all possible action representations (mainly for control actions)
ActionTypeMapping = {
    '0': 'OFF', 'off': 'OFF', 'open': 'OFF', 'disconnect': 'OFF',
    '1': 'ON', 'on': 'ON', 'close': 'ON', 'connect': 'ON', 'energize': 'ON',
    '2': 'UPDATE', 'update': 'UPDATE', 'modify': 'UPDATE', 'set': 'UPDATE', 'change': 'UPDATE', 'fix': 'UPDATE',
}

# Not sure if this is useful😅!
IdentificationTypeMapping = {
    'name': 'NAME', 'id': 'ID', 'num':'NUMBER', 'number': 'NUMBER'
}
...
BSPSSEPyDataFrameArgumentMapping = {
    "GEN": "BSPSSEPyGen",
    "TRN": "BSPSSEPyTrn",
    "BRN": "BSPSSEPyBrn",
    "LOAD": "BSPSSEPyLoad",
...
BSPSSEPyDataFrameMapping = {
    "GEN": "self.BSPSSEPyGen",
    "TRN": "self.BSPSSEPyTrn",
    "BRN": "self.BSPSSEPyBrn",
    "LOAD": "self.BSPSSEPyLoad",
    "BUS": "self.BSPSSEPyLoad"
}
...
'ZG1CZG'  :  ' Zero sequence winding 1 grounding impedance in units governed by CZG',
'ZG2'  :  "ZGRND2' Zero sequence winding 2 grounding impedance in pu",
'ZG2CZG'  :  ' Zero sequence winding 2 grounding impedance in units governed by CZG',
